...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        // TASK 3 - GraphNode vector has unique_ptr GraphNode objects
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
							...
							// TASK 4 - Create a new edge with exclusive ownership requirements
                            ...
                            // TASK 4 - store reference in child node and parent node
							// Use move semantics
	...
	// TASK 5 - Make a local instance of ChatBot
